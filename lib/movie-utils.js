    ...
    saveMovie: function (title, year, format, poster, plot, userId) {
        ...
        return new Promise(function (resolve, reject) {
            utils.getCouchbaseDocument(docKey).then(function (result) {
                ...
                return utils.upsertCouchbaseDocument(docKey, {movieList: movieList}).then(function (result) {
                    resolve(result);
        ...
        return new Promise(function (resolve, reject) {
            utils.getCouchbaseDocument(docKey).then(function (result) {
                ...
                movieUtils.getStats(userId).then(function (stats) {
                    ...
                    return utils.upsertCouchbaseDocument('uid_' + userId + '_stats', finalStats).then(function (result) {
                        return utils.upsertCouchbaseDocument(docKey, {movieList: movieList}).then(function (result) {
                            resolve(result);
